...
## Overlay build and weight sources

Always build overlays on `$TMPDIR`, then copy the `.img` to NFS. Details and which models auto-download weights: [reference/launch.md](reference/launch.md).
