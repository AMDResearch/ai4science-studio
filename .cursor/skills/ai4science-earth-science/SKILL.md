...
description: Applies to Earth-system ML in AI4Science Studio—climate, weather, geospatial data, and model folders under earth_science/models/. Per-model HPC landmines are in reference/models.md.
---
...
## Model-specific HPC notes

Per-model overlay sizes, `--no-deps` lists, ORBIT-2 training landmines, and weather-stack data blockers: [reference/models.md](reference/models.md). Shared Apptainer/Docker patterns: [ai4science-studio/reference/rocm.md](../ai4science-studio/reference/rocm.md).
