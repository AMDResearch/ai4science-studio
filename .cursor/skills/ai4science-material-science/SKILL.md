...
MPI/ADIOS training, DDStore, inference branch mismatch: [reference/hydragnn.md](reference/hydragnn.md). Shared ROCm patterns: [ai4science-studio/reference/rocm.md](../ai4science-studio/reference/rocm.md).
