...
## Quick start (interactive node or Docker)
...
# 3a. Deterministic forecast — 6 steps from 2025-01-01 06Z
python run_inference.py --start 2025-01-01T06 --steps 6

# 3b. Ensemble forecast — 4 members, 12 steps from 2025-08-09 12Z
