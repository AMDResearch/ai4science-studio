...
- The omnistat/TraceLens venv at `${OMNISTAT_VENV:-${OMNIHUB_TOOLS_DIR}/omnihub-inspect}/` (the venv name is site-specific; honour `OMNISTAT_VENV` when set at submit time).
