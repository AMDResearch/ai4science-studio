...
export OMNIHUB_TOOLS_DIR="${OMNIHUB_TOOLS_DIR:?OMNIHUB_TOOLS_DIR must be set (omnihub.tools_dir in .cluster-config.yaml)}"
...
for i in "${!LEVER_NAME[@]}"; do
  ...
  EXP+=",ORBIT2_DATA_ROOT=${ORBIT2_DATA_ROOT},ORBIT2_ROOT=${ORBIT2_ROOT},AI4S_SHARED_DIR=${AI4S_SHARED_DIR},OMNIHUB_TOOLS_DIR=${OMNIHUB_TOOLS_DIR}"
