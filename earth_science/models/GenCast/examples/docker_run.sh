...
#
# NOTE: GenCast and PanguWeather share the same jaxweather:latest image.
#       If you already built it for one, this script will skip the build step.
...
echo ""
echo "Launching $IMAGE_NAME for GenCast ..."
